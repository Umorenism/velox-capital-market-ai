...
// import { FiArrowRight, FiZap, FiTrendingUp, FiShield, FiCpu, FiPlayCircle } from "react-icons/fi";
// import CountUp from "react-countup";
// import { useInView as useObserver } from "react-intersection-observer";

// // IMPORT YOUR HEADER HERE
// import Header from "../components/Header";
// import Footer from "../components/Footer";

// // Video Background (replace with your own high-quality AI trading video later)
...
//   const [ref, inView] = useObserver({ threshold: 0.3, triggerOnce: true });
...
//           >
//             {["Bloomberg", "Forbes", "CNBC", "Financial Times", "Reuters", "TechCrunch", "Barron’s", "The Block"].concat(["Bloomberg", "Forbes", "CNBC", "Financial Times"]).map((name, i) => (
...
//             {[
//               {
//                 icon: <FiZap className="text-6xl" />,
//                 title: "Zero Latency Execution",
//                 desc: "Sub-1ms order routing via 7 global data centers",
//                 gradient: "from-teal-500 to-cyan-400",
//               },
//               {
//                 icon: <FiCpu className="text-6xl" />,
//                 title: "Neural Alpha Engine",
//                 desc: "Deep learning models outperform 97% of hedge funds",
//                 gradient: "from-yellow-500 to-amber-400",
//               },
//               {
//                 icon: <FiShield className="text-6xl" />,
//                 title: "Bank-Grade Security",
//                 desc: "Cold wallet storage • MPC • Biometric 2FA",
...
//                 className="group"
//               >
//                 <div className="relative h-full bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-xl border border-teal-500/30 rounded-3xl p-10 shadow-2xl transition-all duration-500 group-hover:shadow-teal-500/50">
